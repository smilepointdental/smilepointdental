...
?>
    ...
    <li style="visibility: hidden; display: block;">
        <h3>Your Form</h3>
<?php
...
?>
    <br>
    <a style="visibility: hidden;" href="<?php echo self::makeUrl('forgotPassword'); ?>">Forgot password</a>
<?php
endif;
?>
</div>
...
<head>
  ...
  <title>Form Admin Panel | Smile Point </title>
...
<section id="header">
    <div class="container">
        ...
        <a style="visibility: hidden; display: block;" href="<?php echo self::makeUrl(); ?>">Main Menu</a>
...
?>
    ...
    <footer class="footer">
      <div class="container">
        <!--<p class="text-muted" style="visibility: hidden; display: block;">Generated by <a href="http://www.jqueryform.com" target="_blank">JQueryForm.com</a></p>-->
		  <p class="text-muted">Copyright © 2020, <a href="http://ramanagopi.dynv6.net:27960/" title="Smilepoint">Smilepoint</a> All Rights Reserved</p>
      </div>
    </footer>
